...
public abstract class NettySrvAcceptor implements SrvAcceptor {
    ...
    protected void init(){
        ...
        //create && group
        bootstrap= new ServerBootstrap().channel(NativeSupport.isSupportNativeET() ? EpollServerSocketChannel.class : NioServerSocketChannel.class).group(boss, worker);
        //ByteBufAllocator 配置
