...
import com.ut.netty.server.product.common.NativeSupport;
import com.ut.netty.server.product.common.NettyEvent;
import com.ut.netty.server.product.common.NettyEventType;
 ...
 * @time 2018年5月15日20:49:53
 * @modifytime
 */

public class DefaultCommonSrvAcceptor extends DefaultSrvAcceptor {

    private static Logger logger = LoggerFactory.getLogger(DefaultCommonSrvAcceptor.class);
    ...
    //Ack的编码器
    private static final AcknowledgeEncoder ackEncoder = new AcknowledgeEncoder();
